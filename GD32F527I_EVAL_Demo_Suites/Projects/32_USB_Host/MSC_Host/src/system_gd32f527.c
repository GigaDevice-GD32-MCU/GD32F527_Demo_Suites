...
//#define __SYSTEM_CLOCK_220M_PLL_IRC16M          (uint32_t)(220000000)
//#define __SYSTEM_CLOCK_220M_PLL_8M_HXTAL        (uint32_t)(220000000)
//#define __SYSTEM_CLOCK_220M_PLL_25M_HXTAL       (uint32_t)(220000000)
...
#elif defined (__SYSTEM_CLOCK_220M_PLL_IRC16M)
uint32_t SystemCoreClock = __SYSTEM_CLOCK_220M_PLL_IRC16M;
static void system_clock_220M_irc16m(void);
#elif defined (__SYSTEM_CLOCK_220M_PLL_8M_HXTAL)
uint32_t SystemCoreClock = __SYSTEM_CLOCK_220M_PLL_8M_HXTAL;
static void system_clock_220M_8m_hxtal(void);
#elif defined (__SYSTEM_CLOCK_220M_PLL_25M_HXTAL)
uint32_t SystemCoreClock = __SYSTEM_CLOCK_220M_PLL_25M_HXTAL;
static void system_clock_220M_25m_hxtal(void);
...
#elif defined (__SYSTEM_CLOCK_220M_PLL_IRC16M)
    system_clock_220M_irc16m();
#elif defined (__SYSTEM_CLOCK_220M_PLL_8M_HXTAL)
    system_clock_220M_8m_hxtal();
#elif defined (__SYSTEM_CLOCK_220M_PLL_25M_HXTAL)
    system_clock_220M_25m_hxtal();
#endif /* __SYSTEM_CLOCK_IRC16M */   
}
...
#elif defined (__SYSTEM_CLOCK_220M_PLL_IRC16M)
/*!
    \brief      configure the system clock to 220M by PLL which selects IRC16M as its clock source
    \param[in]  none
    \param[out] none
    \retval     none
*/
static void system_clock_220M_irc16m(void)
{
    ...
    /* Configure the main PLL, PSC = 16, PLL_N = 440, PLL_P = 2, PLL_Q = 10 */ 
    RCU_PLL = (16U | (440U << 6U) | (((2U >> 1U) - 1U) << 16U) |
...
#elif defined (__SYSTEM_CLOCK_220M_PLL_8M_HXTAL)
/*!
    \brief      configure the system clock to 220M by PLL which selects HXTAL(8M) as its clock source
    \param[in]  none
    \param[out] none
    \retval     none
*/
static void system_clock_220M_8m_hxtal(void)
{
    ...
    /* Configure the main PLL, PSC = 8, PLL_N = 440, PLL_P = 2, PLL_Q = 10 */ 
    RCU_PLL = (8U | (440U << 6U) | (((2U >> 1U) - 1U) << 16U) |
...
#elif defined (__SYSTEM_CLOCK_220M_PLL_25M_HXTAL)
/*!
    \brief      configure the system clock to 220M by PLL which selects HXTAL(25M) as its clock source
    \param[in]  none
    \param[out] none
    \retval     none
*/
static void system_clock_220M_25m_hxtal(void)
{
    ...
    /* Configure the main PLL, PSC = 25, PLL_N = 440, PLL_P = 2, PLL_Q = 10 */ 
    RCU_PLL = (25U | (440U << 6U) | (((2U >> 1U) - 1U) << 16U) |
                   (RCU_PLLSRC_HXTAL) | (10U << 24U));
